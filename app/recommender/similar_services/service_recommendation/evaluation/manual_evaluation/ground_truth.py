...
if __name__ == '__main__':
    ...
    annotation_files = glob.glob("api/recommender/similar_services/service_recommendation/evaluation/"
                                 "manual_evaluation/storage/manual_evaluation_results/**/*.xlsx")
    ...
    ground_truth_df.to_excel("api/recommender/similar_services/service_recommendation/evaluation/"
                             "manual_evaluation/storage/ground_truth.xlsx",
