...
from app.recommender.similar_services.preprocessor.embeddings.metadata_embeddings import \
    get_metadata_embeddings
from app.recommender.similar_services.preprocessor.similarities.similarities import (
    create_similarities, initialize_similarities, update_similarities)
