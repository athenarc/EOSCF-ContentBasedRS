...
from api.settings import update_backend_settings
...
def main():
    ...
    config_dir = \
        "api/recommender/similar_services/service_recommendation/evaluation/manual_evaluation/configs/distance_configs/best_metadata_attributes/"
    recommendations_store_dir = \
        'api/recommender/similar_services/service_recommendation/evaluation/manual_evaluation/storage/recommendations_for_distance/'
