...
import pandas as pd
from app.recommender.similar_services.service_recommendation.evaluation.manual_evaluation.manual_annotations.create_manual_annotations import \
    ANNOTATORS_POOL

ANNOTATION_DIR = \
    'app/recommender/similar_services/service_recommendation/evaluation/manual_evaluation/' \
    'conflict_resolution/storage/annotated_files/'

MARKED_CONFLICTS_DIR = \
    'app/recommender/similar_services/service_recommendation/evaluation/manual_evaluation/' \
    'conflict_resolution/storage/marked_conflicts/'
